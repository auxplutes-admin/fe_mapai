...
//             Welcome, 
//             <p>To AI Verse</p>
//             <span className="block mt-2">DRC Mining</span>
//           </h1>
...
const scrollToNext = () => {
  const el = document.getElementById("next-section"); // <-- change if needed
...
export const Hero = () => (
  <div className="relative w-full min-h-screen flex items-center justify-center">
    ...
    <button
      ...
      className="
        group absolute left-1/2 -translate-x-1/2 bottom-6
